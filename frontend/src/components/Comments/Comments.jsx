  ...
  return (
    <div className="d-flex justify-content-center py-2">
      <div className="second py-2 px-2">
        <span className="text1">{props.comment}</span>
        <div className="d-flex justify-conte    nt-between py-1 pt-2">
          <div>
            <img src="https://i.imgur.com/AgAC1Is.jpg" width="18" alt="pfp" />
            <span className="text2">{props.author}</span>
          </div>
          <div>
            <span className="text3">Like?</span>
            <HandThumbsUp color="#007bff" size={18} className="ml-1" />
            <span className="text4">{props.likes}</span>
          </div>
        </div>
      </div>
    </div>
